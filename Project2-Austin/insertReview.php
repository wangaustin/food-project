...
<body>
    ...
    if (isset($_POST['field_submit'])) {
        if ($result) {
    ?>
            <p id="light">Review was inserted successfully.</p>
        <?php
        } else {
        ?>
    ...
    <form method="post">
        ...
        <p id="light">Recipe ID: <?php echo $_SESSION["session_recipe_id"]; ?> </p>
        <p id="light">Author ID: <?php echo $_POST['field_author_id']; ?> </p>
        <p id="light">Rating: <?php echo $_POST['field_rating']; ?> </p>
        <p id="light">Review: <?php echo $_POST['field_review']; ?> </p>
