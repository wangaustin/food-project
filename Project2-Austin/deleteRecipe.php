...
if (isset($_POST['field_submit'])) {
    ...
    $query = "CALL deleteMovie(:recipe_name)";
...
<html>
  ...
  <body>
    ...
    <form method="post">
      ...
      <input type="text" name="field_recipe_name" id="search_bar">
    ...
    ?>
          <h3> Error occurred:<br> "<?php echo $var_recipe_name;?>" was not deleted.</h3>
    <?php 
        }
      } 
    ?>
