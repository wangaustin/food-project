...
if (isset($_POST['field_submit'])) {
    ...
    $var_recipeID = $_POST['field_recipe_id'];
    // Save the query into variable called $query. Note that :ph_director is a place holder
    $query = "SELECT * FROM recipe_mega WHERE recipe_name = :ph_recipe";
...
try
    {
      ...
      $prepared_stmt->bindValue(':ph_recipe', $var_recipeID, PDO::PARAM_STR);
...
<!-- Everything inside the BODY tags are visible on page.-->
  <body>
    ...
    <form method="post">
      ...
      <label for="id_recipe">Recipe Name</label>
      ...
      <input type="text" name="field_recipe_id" id = "id_recipe">
    ...
    <?php
      if (isset($_POST['field_submit'])) {
        ...
        <?php } else { ?>
          ...
          <h3>Sorry, no results found for director <?php echo $_POST['field_recipe_id']; ?>. </h3>
        <?php }
    } ?>
