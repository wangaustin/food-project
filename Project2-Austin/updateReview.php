...
<body>
    ...
    <h1>Recipe ID: <?php echo $var_recipe_name; ?></h1>
    <br><br>
        ...
        <table style="width:40%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" name="field_rating" value=<?php echo $result["rating"]; ?> required></td>
                </tr>
                <tr>
                    <th scope="row">Review Details</th>
                    <td><?php echo $result["review"]; ?></td>
                    <td><input type="text" name="field_review" value="<?php echo $result["review"]; ?>""></td>
                </tr>
                <tr>
