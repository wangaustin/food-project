...
if (isset($_POST['event_show_recipe'])) {
...
<body>
  ...
  <form method="post">
    <input type="text" name="field_recipe_id" id="search_bar" placeholder="Search keyword..." required>
    <!-- How many rows? -->
    ...
    <br>
    <br>
    <input type="submit" name="event_show_recipe" value="Submit">
  ...
  ?>
    ...
    <body id="light">Filter is: "<?php
    if ($var_recipe_filter == 0) { echo "Time"; }
    else { echo "Calories"; }
    ?>"</body><br>

    <body id="light">Order is: "<?php
    if ($var_recipe_order == 0) { echo "Descend"; }
    else { echo "Ascend"; }
    ?>"</body><br>
            ...
            <tr>
              ...
              <td>
                <form method="post" action="currentReview.php">
                  <input type="hidden" name="key" value=<?php echo $row["recipe_id"]; ?>>
                  <input type="submit" name="event_review" value="Reviews">
                </form>
              </td>
              <td>
                <form method="post">
