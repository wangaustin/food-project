...
if (isset($_POST['field_submit'])) {
    ...
    $var_recipe_instructions = $_POST['field_recipe_instructions'];
...
<?php
    ...
    ?>
          <h3 id="light"> Sorry, there was an error. Recipe data was not inserted. </h3>
    <?php 
        }
      } 
    ?>
    ...
    <form method="post">
      ...
      <br><br>
    	<input type="text" name="field_recipe_desc" placeholder="Recipe description...">
      <br><br>
